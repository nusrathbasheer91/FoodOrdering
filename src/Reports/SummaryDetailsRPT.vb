...
Public Class SummaryDetailsRPT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "FoodOrdering.SummaryDetailsRPT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSummaryDetailsRPT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SummaryDetailsRPT = New SummaryDetailsRPT()
        rpt.Site = Me.Site
        Return rpt
    End Function
