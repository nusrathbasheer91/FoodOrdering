<%@ Page Title="" Language="vb" AutoEventWireup="false"  CodeBehind="ReportDisplay.aspx.vb" Inherits="FoodOrdering.ReportDisplay" %>
<%@ Register assembly="CrystalDecisions.Web, Version=13.0.2000.0, Culture=neutral, PublicKeyToken=692fbea5521e1304" namespace="CrystalDecisions.Web" tagprefix="CR" %>
<html>
    <head>
        <title>Today's Orders Report Display</title>
        <style>
html
{
